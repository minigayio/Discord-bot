...
run_system() {
  ...
  $DOCKER_RUN "qemu-system-x86_64 -m "4096" -smp $(nproc --all) -nic user,hostfwd=tcp::"25052"-:3389 -drive file=android-x86_64-9.0-r2-k49.iso -display vnc=127.0.0.1:1 -device virtio-tablet-pci -display default,show-cursor=on"                         
