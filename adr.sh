...
run_system() {
  ...
  $DOCKER_RUN "qemu-system-x86_64 -enable-kvm -m 4096 -smp $(nproc --all) -cpu host -nic user,hostfwd=tcp::25076-:3389 -drive file=android.img,format=raw -cdrom android-x86_64-9.0-r2-k49.iso -boot d -usb -usbdevice tablet -device usb-tablet -display vnc=127.0.0.1:1 -vga std"                         
