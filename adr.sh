...
run_system() {
  ...
  $DOCKER_RUN "qemu-system-x86_64 -m "4096" -smp $(nproc --all) -nic user,hostfwd=tcp::"25076"-:3389 -drive file=android-x86_64-9.0-r2-k49.iso -usbdevice tablet -display vnc=127.0.0.1:1, -vga std"                         
