...
run_system() {
  ...
  $DOCKER_RUN "qemu-system-x86_64 -m "4096" -smp $(nproc --all) -nic user,hostfwd=tcp::"25169"-:3389 -drive file=windows11.qcow2 -device virtio-tablet-pci -display vnc=127.0.0.1:1"                         
